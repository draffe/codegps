...
namespace Gps.BasedeDatos.Migrations
{
    ...
    [Migration("20190305180048_MenuopcionesUsuarios")]
    partial class MenuopcionesUsuarios
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gps.BasedeDatos.Modelos.MenuOpciones", b =>
                {
                    ...
                    b.Property<int?>("MenuOpcionesUsuarioId");

                    b.Property<string>("Nombre");

                    b.HasKey("Id");

                    b.HasIndex("MenuOpcionesUsuarioId");
            ...
            modelBuilder.Entity("Gps.BasedeDatos.Modelos.MenuOpciones", b =>
                {
                    b.HasOne("Gps.BasedeDatos.Modelos.MenuOpcionesUsuario")
                        .WithMany("menuOpciones")
                        .HasForeignKey("MenuOpcionesUsuarioId");
                });
